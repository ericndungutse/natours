...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZXJpY25kdW5ndXRzZSIsImEiOiJja3JrZmo2eDMwMm8wMm9ub2liaHB6cjZhIn0.xWa4JtW97rNz7Qy55uMI-Q';
...
var stripe = Stripe('pk_test_51JJDXRGXhbwVVFOkQYoUJkr9nm18Cx61S250j3yh6nWXCAiVRxOYtlkOFM72lXM0AFPLJOIttxtypoEthicAHkzO00YOICHa0C');
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // 4) Update user Data

if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData(); // Append new data to the form
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10759" + '/');
